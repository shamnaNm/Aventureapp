...
class _BookingsPageState extends State<BookingsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(' Our User Bookings', style: TextStyle(color: Colors.white)),
        // actions: [
        //   IconButton(
        ...
        //         context,
        //         MaterialPageRoute(
        //           builder: (context) => UserTicketsPage(userid: '',),
        //         ),
        //       );
        //     },
        //   ),
                      ...
                      child: ListTile(
                        ...
                        subtitle: Column(
                          ...
                          children: [
                            ...
                            Text(
                                'Paid: ₹${booking.amountPaid?.toStringAsFixed(2)}'),
                          ],
                        ),
                        trailing: IconButton(
                            onPressed: () {
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => UserTicketsPage(userid: booking.userid ?? ''),
                            ),
                          );
                        },
                      ),
