...
//
//   const GenerateReview({Key? key, required this.activityTitle}) : super(key: key);
//
//   @override
...
//     try {
//       var userDoc = await FirebaseFirestore.instance.collection('user').doc(uid).get();
//       if (userDoc.exists) {
//         setState(() {
...
//     try {
//       var reviewDocs = await FirebaseFirestore.instance.collection('reviews').where('activityTitle', isEqualTo: widget.activityTitle).get();
//       setState(() {
//         reviews = reviewDocs.docs.map((doc) => GenReview.fromMap(doc.data())).toList();
//       });
//     } catch (e) {
...
//   }
//
//   Widget buildReviewItem(GenReview review, Function() editFunction, Function() deleteFunction) {
//     return Padding(
