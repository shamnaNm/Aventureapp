...
class ActivityTwoBooking extends StatefulWidget {
  const ActivityTwoBooking({super.key, required this.title});
  final String title;
  @override
  State<ActivityTwoBooking> createState() => _ActivityTwoBookingState();
}

class _ActivityTwoBookingState extends State<ActivityTwoBooking> {
  int _counter = 0;
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image: AssetImage(water[1].image.toString()),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                          ...
                          Column(
                            children: [
                              Text("${water[1].title}",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
