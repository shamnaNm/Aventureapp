...
class ActivitySevenBooking extends StatefulWidget {
  const ActivitySevenBooking({super.key, required this.title});
  final String title;
  @override
  State<ActivitySevenBooking> createState() => _ActivitySevenBookingState();
}

class _ActivitySevenBookingState extends State<ActivitySevenBooking> {
  int _counter = 0;
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image:
                                  NetworkImage(road[0].image.toString()),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
