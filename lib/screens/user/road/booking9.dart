...
class ActivityNineBooking extends StatefulWidget {
  const ActivityNineBooking({super.key, required this.title});
  final String title;
  @override
  State<ActivityNineBooking> createState() => _ActivityNineBookingState();
}

class _ActivityNineBookingState extends State<ActivityNineBooking> {
  int _counter = 0;
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image:
                                  NetworkImage(road[2].image.toString()),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
