...
class ActivityTwelveBooking extends StatefulWidget {
  const ActivityTwelveBooking({super.key, required this.title});
  final String title;
  @override
  State<ActivityTwelveBooking> createState() => _ActivityTwelveBookingState();
}

class _ActivityTwelveBookingState extends State<ActivityTwelveBooking> {
  int _counter = 0;
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image:
                                  AssetImage(air[2].image.toString()),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
