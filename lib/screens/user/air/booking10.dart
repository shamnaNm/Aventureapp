...
class ActivityTenBooking extends StatefulWidget {
  const ActivityTenBooking({super.key, required this.title});
  final String title;
  @override
  State<ActivityTenBooking> createState() => _ActivityTenBookingState();
}

class _ActivityTenBookingState extends State<ActivityTenBooking> {
  int _counter = 0;
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image:
                                  AssetImage(air[0].image.toString()),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
