...
class ActivityElevenBooking extends StatefulWidget {
  const ActivityElevenBooking({super.key, required this.title});
  final String title;
  @override
  State<ActivityElevenBooking> createState() => _ActivityElevenBookingState();
}

class _ActivityElevenBookingState extends State<ActivityElevenBooking> {
  int _counter = 0;
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image:
                                  AssetImage(air[1].image.toString()),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
