...
class ActivityFourBooking extends StatefulWidget {
  const ActivityFourBooking({super.key, required this.title});
  final String title;
  @override
  State<ActivityFourBooking> createState() => _ActivityFourBookingState();
}

class _ActivityFourBookingState extends State<ActivityFourBooking> {
  int _counter = 0;
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image:
                                  AssetImage(mountain[0].image.toString()),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
