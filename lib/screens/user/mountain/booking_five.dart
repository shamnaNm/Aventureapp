...
class ActivityFiveBooking extends StatefulWidget {
  const ActivityFiveBooking({super.key, required this.title});
  final String title;
  @override
  State<ActivityFiveBooking> createState() => _ActivityFiveBookingState();
}

class _ActivityFiveBookingState extends State<ActivityFiveBooking> {
  int _counter = 0;
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image:
                                  AssetImage(mountain[1].image.toString()),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
