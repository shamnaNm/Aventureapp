...
class ActivitySixBooking extends StatefulWidget {
  const ActivitySixBooking({super.key, required this.title});
  final String title;
  @override
  State<ActivitySixBooking> createState() => _ActivitySixBookingState();
}

class _ActivitySixBookingState extends State<ActivitySixBooking> {
  int _counter = 0;
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image:
                                  AssetImage(mountain[2].image.toString()),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
